...
const brands = [
  ...
  { name: "Nexpept", logoUrl: "https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://www.nexpept.is/&size=128", category: "Health & Nutrition", location: "Canada", url: "https://www.nexpept.is/", color: "bg-orange-500/10" },
