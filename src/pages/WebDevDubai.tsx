        ...
        <section className="min-h-[70vh] flex items-center px-4 sm:px-6 lg:px-8 py-20 pt-32 bg-secondary/20">
          <div className="container-main text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="https://wa.me/919450010826?text=Hi%20DiziGroww,%20I'm%20interested%20in%20web%20development%20for%20my%20business%20in%20Dubai" target="_blank" rel="noopener noreferrer">
